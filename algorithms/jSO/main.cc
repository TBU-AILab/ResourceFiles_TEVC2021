...
/*
	TOMO UPRAVA pro zrani parametru z konzole
	-----------------------------------------
	0 - nezajem
	1 - #1 dim {10,30,50,100}
	2 - #2 testID <1-30>
	3 - #3 bound <0-5>
*/
	tom_dim = atoi(argv[1]);
	tom_testID = atoi(argv[2]) - 1;
	tom_bound = atoi(argv[3]);
...
*/
 ...
 //for (int i = 0; i < 30; i++) {
 for (int i = tom_testID; i <= tom_testID; i++) {
