...
%%==============================================================================
function [outcome,com_time,SR,avgFE,res_det,seed_run,bestx]= EBO_BIN(run,I_fno, DIM, BOUND)
    ...
    if (current_eval<Par.Max_FES)
        if rand<Probs(1)
            ...
            [EA_1, EA_1old, EA_obj1,probDE1,bestold,bestx,archive,hist_pos,memory_size, archive_f,archive_Cr,archive_T,archive_freq, current_eval,res_det] = ...
                ...
                archive_freq, Par.xmin, Par.xmax,  Par.n,  PS1,  current_eval, I_fno,res_det,Par.Printing,Par.Max_FES, Par.Gmax, iter, BOUND);
        end
    end
    %% ====================== Scout/CMAR phase ======================
    if (current_eval<Par.Max_FES)
        if   rand<Probs(2)
            [ EA_2, EA_obj2, setting,bestold,bestx,bnd,fitness,current_eval,res_det] = ...
                ...
                Par.xmin,Par.xmax,Par.n,PS2,current_eval,I_fno,res_det,Par.Printing,Par.Max_FES, BOUND);
