...
%for boundIN = [0 1 2 3 4 5]   hotovo 0 1 2 3
for boundIN = [4 5]
    fprintf('\tBOUND = %d\n', boundIN)
    for problem_size =[5 10 15 20]
    ...
    for func = [1:10]
        ...
        for run_id = 1 : Runs
            ...
            while nfes < max_nfes
                ...
                Gained_Shared_Junior = boundConstraint(Gained_Shared_Junior, pop, lu, boundIN);
                Gained_Shared_Senior = boundConstraint(Gained_Shared_Senior, pop, lu, boundIN);
            ...
            if (ConvDisp)
                ...
                file_name=sprintf('Figures\\Figure_Bound#%s_Problem#%s_Run#%s',int2str(boundIN),int2str(func),int2str(run_id));
        ...
        file_name=sprintf('Results\\%s_CEC2020_Bound#%s_Problem#%s_problem_size#%s',Alg_Name,int2str(boundIN),int2str(func),int2str(problem_size));
